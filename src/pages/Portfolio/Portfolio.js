...
function Portfolio() {
  return (
    <divportfolio>
      ...
      <div1 class="row">
        <div class="col">
          <div class="card-deck auto p-3 text-center paper">

            <div class="card">
              <img src={resume} class="card-img-top img-fluid" alt="Resume"></img>
            ...
            <div class="card">
              <img src={smartestAmongUs} class="card-img-top img-fluid" alt="Smartest Among Us"></img>
            ...
            <div class="card">
              <img src={qrAidCodes} class="card-img-top img-fluid" alt="QR-Aid-Codes"></img>
              <div class="card-body text-center text-white lavendar">
            ...
            <div class="card">
              <img src={readmeGenerator} class="card-img-top img-fluid" alt="README Generator"></img>
              <div class="card-body text-center text-white overcast">
      ...
      <div2 class="row">
        <div class="col">
          <div class="card-deck auto p-3 text-center paper">
            <div class="card">
              <img src={noteTaker} class="card-img-top img-fluid" alt="Note Taker"></img>
              <div class="card-body text-center text-white overcast">
            ...
            <div class="card">
              <img src={teamProfileGenerator} class="card-img-top img-fluid" alt="Team Profile Generator"></img>
              <div class="card-body text-center text-white lavendar">
            ...
            <div class="card">
              <img src={passwordGenerator} class="card-img-top img-fluid" alt="Password Generator"></img>
              <div class="card-body text-center text-white overcast">
            ...
            <div class="card">
              <img src={workDayScheduler} class="card-img-top img-fluid" alt="Work Day Scheduler"></img>
              <div class="card-body text-center text-white lavendar">
